...
struct Field {
    ...
    void operator()(AJson::Object& object) { object[name] = aui::to_json<T>(value); }
};
...
struct my_tuple : std::tuple<Items...> {
    ...
    auto operator()(T& v, const char* n, AJsonFieldFlags flags = AJsonFieldFlags::DEFAULT) {
        return (std::apply)(
            [&](auto&&... args) { return aui::impl::json::my_tuple(args..., aui::impl::json::Field(v, n, flags)); },
            stdTuple());
    }

    std::tuple<Items...>& stdTuple() { return (std::tuple<Items...>&) *this; }
};
...
#define AJSON_FIELDS(N, ...)                                                     \
    template <>                                                                  \
    struct AJsonConvFieldDescriptor<N> : N {                                     \
        auto operator()() { return aui::impl::json::empty_tuple() __VA_ARGS__; } \
    };
...
struct AJsonConv<T, std::enable_if_t<aui::is_complete<AJsonConvFieldDescriptor<T>>>> {
    static AJson toJson(const T& t) {
        AJson::Object json;
        std::apply(
            [&](auto&&... fields) { aui::parameter_pack::for_each([&](auto&& field) { field(json); }, fields...); },
    ...
    static void fromJson(const AJson& json, T& dst) {
        ...
        std::apply(
            [&](auto&&... fields) {
                aui::parameter_pack::for_each([&](auto&& field) { field(jsonObject); }, fields...);
            },
...
struct AJsonConv<int> {
    static AJson toJson(int v) { return v; }
    static void fromJson(const AJson& json, int& dst) { dst = json.asInt(); }
};

template <>
struct AJsonConv<int64_t> {
    static AJson toJson(int64_t v) { return v; }
    static void fromJson(const AJson& json, int64_t& dst) { dst = json.asLongInt(); }
};

template <>
struct AJsonConv<short> {
    static AJson toJson(int v) { return v; }
    static int fromJson(const AJson& json) { return json.asInt(); }
};

template <>
struct AJsonConv<float> {
    static AJson toJson(float v) { return v; }
    static void fromJson(const AJson& json, float& dst) { dst = json.asNumber(); }
};

template <>
struct AJsonConv<double> {
    static AJson toJson(double v) { return v; }
    static void fromJson(const AJson& json, double& dst) { dst = json.asNumber(); }
};
...
struct AJsonConv<aui::ranged_number<UnderlyingType, min, max>> {
    static AJson toJson(aui::ranged_number<UnderlyingType, min, max> v) { return (UnderlyingType) v; }
...
struct AJsonConv<bool> {
    static AJson toJson(bool v) { return v; }
    static void fromJson(const AJson& json, bool& dst) { dst = json.asBool(); }
};

template <>
struct AJsonConv<AString> {
    static AJson toJson(AString v) { return v; }
    static void fromJson(const AJson& json, AString& dst) { dst = json.asString(); }
};

template <>
struct AJsonConv<APath> {
    static AJson toJson(APath v) { return v; }
    static void fromJson(const AJson& json, APath& dst) { dst = json.asString(); }
};

template <typename T1, typename T2>
struct AJsonConv<std::pair<T1, T2>> {
    static AJson toJson(std::pair<T1, T2> v) { return AJson::Array({aui::to_json(v.first), aui::to_json(v.second)}); }
...
struct AJsonConv<AJson::Array> {
    static AJson toJson(AJson::Array v) { return std::move(v); }
    static void fromJson(const AJson& json, AJson::Array& dst) { dst = json.asArray(); }
};

template <>
struct AJsonConv<AJson::Object> {
    static AJson toJson(AJson::Object v) { return std::move(v); }
    static void fromJson(const AJson& json, AJson::Object& dst) { dst = json.asObject(); }
};
...
struct AJsonConv<T, typename std::enable_if_t<std::is_enum_v<T>>> {
    static AJson toJson(const T& v) { return AEnumerate<T>::names()[v]; }
    static void fromJson(const AJson& json, T& dst) { dst = AEnumerate<T>::byName(json.asString()); }
};
