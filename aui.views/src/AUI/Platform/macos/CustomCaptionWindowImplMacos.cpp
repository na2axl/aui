...
// Apple HIG: default traffic-light cluster occupies roughly 70pt from the left edge of the
// titlebar. Reserving 80pt leaves a small breathing margin before user content.
